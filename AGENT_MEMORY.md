...
|-------|-----------|---------|-------|
| Platform | Android (Kotlin, Jetpack Compose, Material 3) | 1.8.1 | Child of agent-project-bootstrap; GitHub Releases APK `astroalarm-X.Y.Z-foss.apk` |
...
| 2026-09-13 | v1.8.1 /ship | AlarmManager→Activity fire + TTS; blocking permission dialog; RP #20; versionCode **10106** | Do not apply `vcodeql-bundle-*`; notifications still needed for shade Stop/Snooze |
...
- **Template version:** `1.8.2` (see `.template-version`)
