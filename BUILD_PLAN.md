...
> **Sprint 0** archived in COMPLETED_TASKS.md @ `825fb6d`.

### Parallel (archived)

<!-- parallel_exception: Sprint 0 archived — see COMPLETED_TASKS.md -->
...
<!-- parallel_exception: Sprint 1 archived — see COMPLETED_TASKS.md -->
...
| Issue | Resolution |
|----|---|
| Null/empty at boundary | Invalid `AstroPlace` falls back to `ZoneId.systemDefault()` and “using device timezone”; tests in `SolarTermCalculatorTest` / `SolarTermWheelRenderTest` |
