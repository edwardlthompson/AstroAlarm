...
* **android:** show Yearly solstice and equinox alarms on Earth's Sol path with fire times

### Fixed

* **android:** treat overlapping Sun and Yearly seasonal calendars as one fire
