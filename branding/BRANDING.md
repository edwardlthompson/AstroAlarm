...
| `assets/app-icon-512.svg` | Export to store `icon.png` 512×512 (`[HUMAN]`/`[ADB]`); README Demo |
| `assets/splash.svg` | Launch splash (matches Android `splash_background.xml`); README Demo |
