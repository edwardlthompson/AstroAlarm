...
**Product:** AstroAlarm
**Purpose:** FOSS Android astronomical and solar/lunar clock alarm app with on-device Meeus/NOAA ephemeris, custom clock wheels, lockscreen snooze/stop with math unlock challenge, and rotating day/night home widgets.
**Stack:** android
<!-- /bootstrap-project-card -->
...
- ✅ Optional: `just local-compute` + `just ensure-local-model` (`docs/LOCAL_MODELS.md`)
- 🔲 Optional: `/emulator` if you have an Android SDK
