...
**Purpose & Goals:** FOSS Android astronomical and solar/lunar clock alarm app with on-device Meeus/NOAA ephemeris, custom clock wheels, lockscreen snooze/stop with math unlock challenge, and rotating day/night home widgets.

**Stakeholders:** People who want solar, lunar, or custom clock alarms without a cloud service. Maintainers ship MIT APKs via GitHub Releases.

**Non-goals:** Google Play listing, Play Services, Firebase, remote ephemeris APIs, social accounts, and in-app purchases.

**Success metrics:** Offline-correct next-fire times for a set city; lockscreen snooze/stop with optional math unlock; rotating widget shows the next alarm; `assembleRelease` and unit tests stay green.
