...
| View | `Astro3DTransitOverlay.kt`, `Astro3DRenderer.kt` |
| Tests | `TransitTicksTest.kt` |
| Wiring | renderer call only |

## Tests

- ✅ Automated: yes — `TransitTicksTest.kt`, `ClockParallaxTest.kt`, `ZodiacGlyphTest.kt`
