...
object Astro3DRenderer {
    fun render3D(
        ...
        draw(Canvas(bitmap), place, alarms, now, size, showZodiac, showEventTimes, parallaxX, parallaxY, earth, moon)
        return bitmap
    }
    fun draw(
        canvas: Canvas,
        ...
        EarthGlobeRenderer.drawGlobe(canvas, globeCx, globeCy, globeR, lat, lon, earth, true, sunDec, subLon, "earth")
